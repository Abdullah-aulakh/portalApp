...
Router.get("/:id/courses", authentication,DepartmentController.getDepartmentCourses);
...
Router.get("/courses/:id", authentication,authorization([UserRoles.ADMIN]),DepartmentController.getDepartmentCourses);
