...
Router.get("/", authentication,authorization([UserRoles.ADMIN,UserRoles.TEACHER]),GradeController.getAllGrades);
Router.get("/reg/:registrationNumber", authentication,authorization([UserRoles.ADMIN]),GradeController.getStudentGrades);
Router.post("/", authentication,authorization([UserRoles.ADMIN,UserRoles.TEACHER]),GradeController.createGrade);
